            ...
            <List>
                <ListItem disablePadding sx={{ display: 'block' }}>
                    <List component="div" disablePadding>
                        <ListItemButton onClick={() => NavigateTo("/category_tiles")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="Category Tiles">
                                    <Checklist color="primary" />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="Category Tiles" sx={{ pl: 1 }} />}
                        </ListItemButton>
                        <ListItemButton onClick={() => NavigateTo("/customer_table")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="Customer Table">
                                    <EditNote color="primary" />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="Customer Table" sx={{ pl: 1 }} />}
                        </ListItemButton>
                        ...
                        <ListItemButton onClick={() => NavigateTo("/order_tiles")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="Order Tiles">
                                    <GridView color="primary" />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="Order Tiles" sx={{ pl: 1 }} />}
                        </ListItemButton>
                        ...
                        <ListItemButton onClick={() => NavigateTo("/shoppingcart_tiles")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="ShoppingCart Tiles">
                                    <Toc color="primary" />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="ShoppingCart Tiles" sx={{ pl: 1 }} />}
                        </ListItemButton>
                    </List>
                </ListItem>
            </List>
